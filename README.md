...
AI Chain — Distributed multi-node LLM inference with automatic failover. Chain Ollama models across Raspberry Pi fleet for load-balanced AI at the edge. FastAPI + Python. (BlackRoad integration)
